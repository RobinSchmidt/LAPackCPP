/* zgbrfsx.f -- translated by f2c (version 20100827).
...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/zgbrfsx
.f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/zgbrfsx
.f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/zgbrfsx
.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
...
/* Subroutine */ int zgbrfsx_(char *trans, char *equed, integer *n, integer *
	...
	work, doublereal *rwork, integer *info, ftnlen trans_len, ftnlen 
	equed_len)
{
    ...
    /* Local variables */
    static doublereal illrcond_thresh__, unstable_thresh__, err_lbnd__;
    static integer ref_type__;
    extern integer ilatrans_(char *, ftnlen);
    static integer j;
    static doublereal rcond_tmp__;
    static integer trans_type__;
    static doublereal cwise_wrong__;
    static char norm[1];
    ...
    extern doublereal zla_gbrcond_c__(char *, integer *, integer *, integer *,
	    ...
	    *, doublecomplex *, integer *, doublecomplex *, integer *, 
	    ...
	    doublereal *, ftnlen), dlamch_(char *, ftnlen);
